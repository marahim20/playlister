...
export default function Hero() {
    return (
        <section className="flex flex-col md:flex-row items-center justify-center h-3/4">
            <Image src="/main_illustration.svg" width={400} height={400} alt="main_image" priority className="select-none" />
            <div className="flex flex-col gap-4">
                <h1 className="font-heading text-6xl text-primary select-none">PlayLister</h1>
                <p className="font-body text-base max-w-xs text-text select-none">
